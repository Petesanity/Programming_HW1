...
public class Student implements Runnable {
	...
	/**
	 * Student thread. alternate between programming and seeking help from TA
	 */
	...
	/**
	 * The run method will infinitely loop between programming and asking for help
	...
	public void run() {
		...
		while (true) {
			try {
				// Program first.
				System.out.println("Student " + studentNum + " has started"
						         + "programming for " + programTime + " seconds.");
				
				thread.sleep(programTime * 1000);

				// Check to see if TA is available.
					...
					if (chairs.tryAcquire()) {
						try {
							...
							System.out.println("Student " + studentNum + " is sitting outside the office.  " + "He is #"
									+ ((3 - chairs.availablePermits())) + " in line.");
							available.acquire();
							System.out.println("Student " + studentNum + " has started working with the TA.");
							thread.sleep(5000);
							System.out.println("Student " + studentNum + " has stopped working with the TA.");
						...
						System.out.println("Student " + studentNum + " could not see the TA and"
								+ "all chairs were taken.  Back to programming!");
